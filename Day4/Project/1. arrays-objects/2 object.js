...
console.log(`Hello, I'm a penguin and my name is ${myPenguin.name} !`) // Style: Semicolon missing
...
myPenguin.chirp = function () { console.log("CHIRP CHIRP! Is this what penguins sound like?!") } // Style: Semicolon missing
...
myPenguin.sayHello = function () { console.log(`Hello, I'm a penguin and my name is ${this.name} !`) } // Style: Semicolon missing & function operations should come in next line
...
myPenguin.fly = function () {
    if (myPenguin.canFly) {
        ...
        console.log('No, flying is not for me');
    }
}
